{
  ...
  initComponent: function(){
    // passing config options to BasicForm in 4.0.x is possible via initialConfig only
    // see Ext.form.Panel documentation
    this.initialConfig = {}
      // form tracks it's default field values so they can be reset()
    this.trackResetOnLoad = this.initialConfig.trackResetOnLoad = true;
    this.errorReader      = this.initialConfig.errorReader      = Ext.create("reader.netzke");
